...
function getDocs(){
  ...
  for(var i = 0; i < files.length; i++){
    ...
    list.innerHTML += "<tr onclick=\"location.href='docs/site/"+files[i]+"/index.html'\" class='docListItem'><td style=\"width:20%\">"+json.docName+"</td><td><i>"+json.description+"</i></td></tr>";
  }
}
